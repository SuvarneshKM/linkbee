...
const PageForm = ({
  ...
  const handleSubmit = (values: NewPageParams) => {
    if (editing) {
      ...
      createPage({
        ...values,
        slug: convertSpacesAndRemoveSpecialChars(values.slug),
      });
    }
  };
  const convertSpacesAndRemoveSpecialChars = (inputString: string): string => {
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                {form.watch("slug") === ""
                  ? "slug"
                  : convertSpacesAndRemoveSpecialChars(form.watch("slug"))}
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
